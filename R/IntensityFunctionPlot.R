...
#' This list is typically generated by the \code{\link{EstimateThetaT}} function.
#' @param model.number a scalar containing the index of the model to plot in the \code{model.estimates} list.
#' @param best.models a list containing the names and corresponding indices of all models in the \code{model.estimates} list.
