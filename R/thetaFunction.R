...
#'
#' Calculates the value of \eqn{\theta(t)} at an individual time point t
#'
#' @param t the time at which to calculate \eqn{\theta(t)}. The function \code{\link{HaslingerQ}} integrates this function, so t can be of any length (including 1).
