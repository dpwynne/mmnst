...
#' This list is typically generated by the estimate.theta.t function.
...
#' @param neuron.name a string containing the name of the neuron being plotted, used only in the file metadata
...
#'
#' @return a list of ggplot objects, each of which contains the parameters necessary for producing one intensity function plot
#'
#' @export

plot.intensity.function <- function(model.estimates, model.number, best.models, add.title=F, filename=NULL, neuron.name=NULL, time.resolution = NULL, y.limits = NULL, axis.label.size = 18, title.size = 24, IC.type=NULL, RStudio=FALSE){
